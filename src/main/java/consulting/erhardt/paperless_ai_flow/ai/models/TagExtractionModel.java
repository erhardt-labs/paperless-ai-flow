...
import consulting.erhardt.paperless_ai_flow.ai.dtos.TagsDto;
...
public class TagExtractionModel extends AbstractAiModel {
    ...
    @SneakyThrows
    public @NonNull List<Long> process(@NonNull String content, @NonNull List<PaperlessTag> availableTags) {
    ...
    private String buildUserPromptWithTags(String content, List<PaperlessTag> availableTags) {
