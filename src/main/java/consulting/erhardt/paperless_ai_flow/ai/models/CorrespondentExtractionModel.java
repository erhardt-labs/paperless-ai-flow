...
import consulting.erhardt.paperless_ai_flow.ai.dtos.CorrespondentDto;
...
public class CorrespondentExtractionModel extends AbstractAiModel {
    ...
    @SneakyThrows
    public Long process(@NonNull String content, @NonNull List<PaperlessCorrespondent> availableCorrespondents) {
    ...
    private String buildUserPromptWithCorrespondents(String content, List<PaperlessCorrespondent> availableCorrespondents) {
