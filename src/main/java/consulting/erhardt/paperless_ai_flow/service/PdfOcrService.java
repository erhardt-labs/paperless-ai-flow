...
public class PdfOcrService {
     ...
     */
    public Mono<String> processDocument(PaperlessDocument document, PipelineDefinition pipelineDefinition) {
     ...
     */
    private Flux<BufferedImage> convertPdfToImages(byte[] pdfBytes, Long documentId) {
