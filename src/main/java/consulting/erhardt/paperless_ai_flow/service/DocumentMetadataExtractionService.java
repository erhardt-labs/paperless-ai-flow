...
public class DocumentMetadataExtractionService {
    ...
    public Mono<DocumentMetadataDto> extractMetadata(@NonNull String content) {
        ...
        var tagsMono = paperlessApiClient.getTags().collectList();
        var correspondentsMono = paperlessApiClient.getCorrespondents().collectList();
        var customFieldsMono = paperlessApiClient.getCustomFields().collectList();
    ...
    private Mono<List<Long>> extractTags(String content, List<PaperlessTag> availableTags) {
    ...
    private Mono<Long> extractCorrespondent(String content, List<PaperlessCorrespondent> availableCorrespondents) {
    ...
    private Mono<java.util.Map<Long, String>> extractCustomFields(String content, List<PaperlessCustomField> availableCustomFields) {
