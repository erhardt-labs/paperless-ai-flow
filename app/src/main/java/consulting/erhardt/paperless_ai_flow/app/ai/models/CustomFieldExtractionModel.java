...
public class CustomFieldExtractionModel extends AbstractAiModel {
  ...
  @SneakyThrows
  public @NonNull Map<Long, String> process(@NonNull String content, @NonNull List<CustomField> availableCustomFields) {
  ...
  private String buildUserPromptWithCustomFields(String content, List<CustomField> availableCustomFields) {
