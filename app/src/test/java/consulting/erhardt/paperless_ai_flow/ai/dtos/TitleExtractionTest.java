...
class TitleExtractionTest {
  ...
  void titleDto_shouldBeValidAgainstJsonSchema() throws Exception {
    // Given
    var titleDto = new TitleExtraction("Sample Document Title");
  ...
  void titleDto_shouldHandleEmptyTitle() throws Exception {
    // Given
    var titleDto = new TitleExtraction("");
  ...
  void titleDto_shouldHandleSpecialCharacters() throws Exception {
    // Given
    var titleDto = new TitleExtraction("Invoice & Receipt (2024) - €1,234.56");
  ...
  void titleDto_shouldDeserializeFromValidJson() throws Exception {
    ...
    // When
    var titleDto = objectMapper.readValue(validJson, TitleExtraction.class);
